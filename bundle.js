...
var app = new _vue2.default({
  ...
  methods: {
    ...
    updateTodos: function updateTodos() {
      var dataString = JSON.stringify(this.items);
      var avTodos = _leancloudStorage2.default.Object.createWithoutData('AllTodos', this.items.id);
      avTodos.set('content', dataString);
    ...
    addList: function addList() {
      var times = new Date();
      var timess = times.getFullYear() + "年" + (times.getMonth() + 1) + "月" + times.getDate() + "日";
      this.items.push({
    ...
    login: function login() {
      ...
      _leancloudStorage2.default.User.logIn(this.formDate.username, this.formDate.password).then(function (loginedUser) {
